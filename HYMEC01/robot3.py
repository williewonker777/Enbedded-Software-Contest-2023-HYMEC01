...
class MyBidirectionalNode(Node):
    def __init__(self):
        ...
        self.robot3_subscription = self.create_subscription(String, 'robot1_complete', self.forward_to_arduino_callback, 10)
        self.robot4_subscription = self.create_subscription(String, 'robot4_complete', self.forward_to_arduino_callback, 10)

        self.publisher = self.create_publisher(String, 'debug3_topic', 10)
        self.complete_publisher = self.create_publisher(String, 'robot3_complete', 10)  
