...
class MyBidirectionalNode(Node):
    def __init__(self):
        ...
        self.robot2_subscription = self.create_subscription(String, 'robot1_complete', self.forward_to_arduino_callback,10)
        ...
        self.complete_publisher = self.create_publisher(String, 'robot2_complete', 10)  
